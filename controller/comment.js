...
var controller = {
    ...
    add: function (req, res) {
        ...
        Topic.findById(topicId).exec((err, topic) => {
            ...
            //Comprobar objeto usuario(Si esta registyrado..) y validar datos
            if (req.body.content) {
                ...
                if (validate_content) {
                    ...
                    return res.status(200).send({
                        message: 'No se han validado lo datos del comentario'
                    });
                }
    ...
    delete: function (req, res) {
        //Sacar el id del comentario a borrar
        var topicId = req.params.topicId;
        var commentId = req.params.commentId;
